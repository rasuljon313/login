...
// import CarModal from '../modal/CModal';
...
//   //   setLoadingModels(true);
//   //   setLoadingBrands(true);
//   //   const apiUrl = editID ? `https://realauto.limsa.uz/api/cars/${editID}` : "https://realauto.limsa.uz/api/cars";
...
//     setLoadingBrands(true);
//     const apiUrl = editID
//       ? `https://realauto.limsa.uz/api/cars/${editID}`
...
//     if (categoryToDelete) {
//       fetch(`https://realauto.limsa.uz/api/cars/${categoryToDelete}`, {
//         method: "DELETE",
//         headers: {
//           Authorization: `Bearer ${token}`,
//         },
...
//       </header>
//       {open && (
//   <CarModal createOrEditCategory={createOrEditCategory} editID={editID} setOpen={setOpen} loading={loadingModels || loadingBrands} categoryBrand={categoryBrand} setSelectbrand={setSelectbrand} setName={setName} name={name} selectBrand={selectBrand}/>)}
