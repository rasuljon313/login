...
const Mainmodal = ({setOpen, catigory, name, nameRu, setName, setNameRu, setImg, edit, loading, resetForm, existingImageSrc  
    ...
    const handleOverlayClick = (e) => {if (e.target === e.currentTarget) { setOpen(false); resetForm(); }};
        ...
        <div>
         ...
         {existingImageSrc && (
          <div className="modal_imgs">
              <p>Existing Image</p>
              <img  src={`https://realauto.limsa.uz/api/uploads/images/${existingImageSrc}`}  alt="Existing Category"  style={{ width: '100px', height: 'auto' }}  />
          </div>
       )}
